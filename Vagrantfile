...
Vagrant.configure("2") do |config|
  ...
  # replace with longhorn
  # config.vm.define "storage" do |storage|
  #   storage.vm.hostname = "storage"
  #   storage.vm.box = "bento/ubuntu-23.04"
  #   storage.vm.box_check_update = false
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.box = "bento/ubuntu-23.04"
  ...
  (1..3).each do |i|
    config.vm.define "worker-#{i}" do |worker|
      ...
      worker.vm.box = "bento/ubuntu-23.04"
      ...
      worker.vm.provision "shell", path: "./scripts/addons.sh"
